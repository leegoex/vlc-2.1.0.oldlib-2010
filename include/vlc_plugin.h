...
#ifdef __PLUGIN__
#   define __VLC_SYMBOL( symbol1, symbol2 ) CONCATENATE( symbol1, symbol2 )
#else
#   define __VLC_SYMBOL( symbol1, symbol2 ) CONCATENATE( symbol1, symbol2 )
#endif
// sunqueen modify end
...
int CDECL_SYMBOL __VLC_SYMBOL(vlc_entry, symbol) (vlc_set_cb, void *); \
EXTERN_SYMBOL DLL_SYMBOL \
int CDECL_SYMBOL __VLC_SYMBOL(vlc_entry, symbol) (vlc_set_cb vlc_set, void *opaque) \
{ \
    module_t *module; \
