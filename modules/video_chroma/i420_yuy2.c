...
#    define VLC_TARGET
#	 define __MODULE_BEGIN_NAME	i420_yuy2						// sunqueen add
#elif defined (MODULE_NAME_IS_i420_yuy2_mmx)
#    define DEST_FOURCC "YUY2,YUNV,YVYU,UYVY,UYNV,Y422,IUYV,cyuv"
#    define VLC_TARGET VLC_MMX
#	 define __MODULE_BEGIN_NAME	i420_yuy2_mmx					// sunqueen add
#elif defined (MODULE_NAME_IS_i420_yuy2_sse2)
#    define DEST_FOURCC "YUY2,YUNV,YVYU,UYVY,UYNV,Y422,IUYV,cyuv"
#    define VLC_TARGET VLC_SSE
#	 define __MODULE_BEGIN_NAME	i420_yuy2_sse2					// sunqueen add
#elif defined (MODULE_NAME_IS_i420_yuy2_altivec)
#    define DEST_FOURCC "YUY2,YUNV,YVYU,UYVY,UYNV,Y422"
#    define VLC_TARGET
#	 define __MODULE_BEGIN_NAME	i420_yuy2_altivec				// sunqueen add
#endif
 ...
 * Module descriptor.
 *****************************************************************************/
vlc_module_begin ( __MODULE_BEGIN_NAME )				// sunqueen modify
#if defined (MODULE_NAME_IS_i420_yuy2)
