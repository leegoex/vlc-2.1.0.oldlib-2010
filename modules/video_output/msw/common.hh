// sunqueen rename common.c to common.hh
/*****************************************************************************
 * common.c:
 *****************************************************************************
...
/* */
static int CommonInit(vout_display_t *vd)				// sunqueen modify
{
...
/* */
static void CommonClean(vout_display_t *vd)				// sunqueen modify
{
    vout_display_sys_t *sys = vd->sys;
...
static void CommonManage(vout_display_t *vd)				// sunqueen modify
{
    vout_display_sys_t *sys = vd->sys;
 ...
 * is displayed.
 */
static void CommonDisplay(vout_display_t *vd)				// sunqueen modify
{
    vout_display_sys_t *sys = vd->sys;
 ...
 * picture.
 *****************************************************************************/
static void UpdateRects(vout_display_t *vd,
                  const vout_display_cfg_t *cfg,
                  const video_format_t *source,
                  bool is_forced)				// sunqueen modify
{
    vout_display_sys_t *sys = vd->sys;
...
static int CommonControl(vout_display_t *vd, int query, va_list args)				// sunqueen modify
{
    vout_display_sys_t *sys = vd->sys;
