// sunqueen rename csa.c to csa.h
// and remove csa.h
/*****************************************************************************
 ...
 * csa_New:
 *****************************************************************************/
static csa_t *csa_New( void )			// sunqueen modify
{
 ...
 * csa_Delete:
 *****************************************************************************/
static void csa_Delete( csa_t *c )			// sunqueen modify
{
    free( c );
}
 ...
 * csa_SetCW:
 *****************************************************************************/
static int csa_SetCW( vlc_object_t *p_caller, csa_t *c, char *psz_ck, bool set_odd )			// sunqueen modify
{
    if ( !c )
    {
 ...
 * csa_UseKey:
 *****************************************************************************/
static int csa_UseKey( vlc_object_t *p_caller, csa_t *c, bool use_odd )			// sunqueen modify
{
 ...
 * csa_Decrypt:
 *****************************************************************************/
static void csa_Decrypt( csa_t *c, uint8_t *pkt, int i_pkt_size )				// sunqueen modify
{
    uint8_t *ck;
    uint8_t *kk;
 ...
 * csa_Encrypt:
 *****************************************************************************/
static void csa_Encrypt( csa_t *c, uint8_t *pkt, int i_pkt_size )				// sunqueen modify
{
    uint8_t *ck;
    uint8_t *kk;
