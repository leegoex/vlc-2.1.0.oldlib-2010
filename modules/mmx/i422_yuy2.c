...
#	 define __MODULE_BEGIN_NAME	i422_yuy2			// sunqueen add
#else
#    define DEST_FOURCC "YUY2,YUNV,YVYU,UYVY,UYNV,Y422,IUYV,cyuv"
#if defined (MODULE_NAME_IS_i422_yuy2_mmx)
#	 define __MODULE_BEGIN_NAME	i422_yuy2_mmx		// sunqueen add
#elif defined (MODULE_NAME_IS_i422_yuy2_sse2)
#	 define __MODULE_BEGIN_NAME	i422_yuy2_sse2		// sunqueen add
#endif
#endif
